...
pub async fn post_new_course(
    ...
    post_new_course_db(&app_state.db, course.0)
        .await
        .map(|course| HttpResponse::Ok().json(course))
}
...
mod tests {
    ...
    async fn post_course_success() {
        ...
        let new_course_msg = CreateCourse {
            tutor_id: 1,
            course_name: "Learning Perl 6".into(),
            course_description: Some("This course is about Perl 6 programming.".into()),
            course_format: None,
    ...
    async fn update_course_success() {
        ...
        let update_course_msg = UpdateCourse {
            course_name: Some("Learning Raku".into()),
            course_description: Some("This course is about Raku programming.".into()),
            course_format: None,
